    ...
    render() {
        return (
            <View style={style.container}>
                <LinearGradient colors={['#FFF68F', '#EEE685']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={style.containText} >
                ...
                <LinearGradient colors={['#54FF9F', '#43CD80']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={style.containText} >
                ...
                <LinearGradient colors={['#FFFF00', '#FFD700']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={style.containText} >
                ...
                <LinearGradient colors={['#FF4500', '#CD3700']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={style.containText} >
